...
public class RideController {
    ...
    @Operation(
            summary = "List rides",
            description = "Returns every ride."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            summary = "Get a ride",
            description = "Returns one ride by its database identifier."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
                    description = "Ride returned"
            ),
            @ApiResponse(
                    responseCode = "404",
    ...
    public RideEntity createRide(
            @Valid @RequestBody RideEntity ride) {
